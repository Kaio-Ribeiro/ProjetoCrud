<?php
    ...
    if(isset($_POST["editar"]) && !empty($_POST["editar"])){
        unset($_POST["editar"]);
        $editar = new Editar("idioma", $_POST, $_POST["idioma_id"]);
        $tab = $editar->editar();
        echo $editar;
    }

    if(isset($_POST["excluir"]) && !empty($_POST["excluir"])){
        $apagar = new Excluir("idioma", $_POST["excluir"]);
        ...
        <table>
            <caption>
                ...
                <form method="POST" action="formCriar.php">
                    ...
                    <input name="criar" type="hidden" value="idioma">
                </form>
            </caption>
            <thead>
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="formEditar.php">
                                ...
                                <input name="editar_id" type="hidden" value="<?= $valor["idioma_id"]?>">
                                <input name="editar_nome" type="hidden" value="<?= "idioma"?>">
                            </form>
                            <form method="POST" action="idioma.php">
                                <button type="submit">Excluir</button>
                                <input name="excluir" type="hidden" value="<?= $valor["idioma_id"]?>">
                            </form>
                        </td>
                    </tr>
                    <?php } ?>
